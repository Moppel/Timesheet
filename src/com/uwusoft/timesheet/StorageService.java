...
public interface StorageService {
     ...
     */
    void storeTimeEntry(Date dateTime, String task) throws IOException, ServiceException;
     ...
     * @throws ServiceException
     */
    void storeTimeEntry(Date dateTime, String task, String defaultTotal) throws IOException, ServiceException;

    void storeLastDailyTotal();

    void storeLastWeekTotal();
    
    void submitEntries() throws IOException, ServiceException, ParseException;
}
